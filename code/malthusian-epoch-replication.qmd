---
title: "Replication of Ashraf and Galor (2011)"
format: pdf
---
...
wb_regions = read_csv("world-regions-according-to-the-world-bank.csv")
```
...
The following code replicates Column 5 of Table 2 (impact of years since 
Neolitic transition on log population density in 1500 CE). The first
equation follows Ashraf and Galor's regression, while the second substitutes
their continental dummies for Kelly's controls (Europe, South Asia, and
below 10 degrees south).
