...
mod1 = lm(gtfp ~ conf + yinit + hc + inv + gpop + period + opres + dp + gv, data = data)

mod2 = lm(gtfp ~ conf + yinit + hc + inv + gpop + opres + dp + gv,
          data = data |> filter(period == "1970-1979"))

mod3 = lm(gtfp ~ conf + yinit + hc + inv + gpop + opres + dp + gv,
          data = data |> filter(period == "1980-1989"))

mod4 = lm(gtfp ~ conf + yinit + hc + inv + gpop + opres + dp + gv,
          data = data |> filter(period == "1990-1999"))

mod5 = lm(gtfp ~ conf + yinit + hc + inv + gpop + opres + dp + gv,
          data = data |> filter(period == "2000-2009"))

mod6 = lm(gtfp ~ conf + yinit + hc + inv + gpop + opres + dp + gv,
          data = data |> filter(period == "2010-2019"))

mod7 = lm(gtfp ~ conf + yinit + hc + inv + gpop + period + region + opres + dp + gv,
          data = data)

mod8 = lm(gtfp ~ conf + yinit + hc + inv + gpop + period + kkz96 +
            kgatrstr + lang + opres + dp + gv, data = data)

mod21 = lm(gtfp ~ kkz96 + yinit + hc + inv + gpop + period + opres + dp + gv, data = data)

mod22 = lm(gtfp ~ kkz96 + yinit + hc + inv + gpop + opres + dp + gv,
           data = data |> filter(period == "1970-1979"))

mod23 = lm(gtfp ~ kkz96 + yinit + hc + inv + gpop + opres + dp + gv,
           data = data |> filter(period == "1980-1989"))

mod24 = lm(gtfp ~ kkz96 + yinit + hc + inv + gpop + opres + dp + gv,
           data = data |> filter(period == "1990-1999"))

mod25 = lm(gtfp ~ kkz96 + yinit + hc + inv + gpop + opres + dp + gv,
           data = data |> filter(period == "2000-2009"))

mod26 = lm(gtfp ~ kkz96 + yinit + hc + inv + gpop + opres + dp + gv,
           data = data |> filter(period == "2010-2019"))

mod27 = lm(gtfp ~ kkz96 + yinit + hc + inv + gpop + period + region + opres + dp + gv,
           data = data)

mod28 = lm(gtfp ~ kkz96 + yinit + hc + inv + gpop + period + conf +
             kgatrstr + lang + opres + dp + gv, data = data)

mod31 = lm(gtfp ~ kgatrstr + yinit + hc + inv + gpop + period + opres + dp + gv, data = data)

mod32 = lm(gtfp ~ kgatrstr + yinit + hc + inv + gpop + opres + dp + gv,
           data = data |> filter(period == "1970-1979"))

mod33 = lm(gtfp ~ kgatrstr + yinit + hc + inv + gpop + opres + dp + gv,
           data = data |> filter(period == "1980-1989"))

mod34 = lm(gtfp ~ kgatrstr + yinit + hc + inv + gpop + opres + dp + gv,
           data = data |> filter(period == "1990-1999"))

mod35 = lm(gtfp ~ kgatrstr + yinit + hc + inv + gpop + opres + dp + gv,
           data = data |> filter(period == "2000-2009"))

mod36 = lm(gtfp ~ kgatrstr + yinit + hc + inv + gpop + opres + dp + gv,
           data = data |> filter(period == "2010-2019"))

mod37 = lm(gtfp ~ kgatrstr + yinit + hc + inv + gpop + period + region + opres + dp + gv,
           data = data)

mod38 = lm(gtfp ~ kgatrstr + yinit + hc + inv + gpop + period + kkz96 +
             conf + lang + opres + dp + gv, data = data)

mod41 = lm(gtfp ~ lang + yinit + hc + inv + gpop + period + opres + dp + gv, data = data)

mod42 = lm(gtfp ~ lang + yinit + hc + inv + gpop + opres + dp + gv,
           data = data |> filter(period == "1970-1979"))

mod43 = lm(gtfp ~ lang + yinit + hc + inv + gpop + opres + dp + gv,
           data = data |> filter(period == "1980-1989"))

mod44 = lm(gtfp ~ lang + yinit + hc + inv + gpop + opres + dp + gv,
           data = data |> filter(period == "1990-1999"))

mod45 = lm(gtfp ~ lang + yinit + hc + inv + gpop + opres + dp + gv,
           data = data |> filter(period == "2000-2009"))

mod46 = lm(gtfp ~ lang + yinit + hc + inv + gpop + opres + dp + gv,
           data = data |> filter(period == "2010-2019"))

mod47 = lm(gtfp ~ lang + yinit + hc + inv + gpop + period + region + opres + dp + gv,
           data = data)
