...
mod1 = lm(gh ~ conf + yinit + hc + inv + gpop + period, data = data)

mod2 = lm(gh ~ conf + yinit + hc + inv + gpop,
          data = data |> filter(period == "1970-1979"))

mod3 = lm(gh ~ conf + yinit + hc + inv + gpop,
          data = data |> filter(period == "1980-1989"))

mod4 = lm(gh ~ conf + yinit + hc + inv + gpop,
          data = data |> filter(period == "1990-1999"))

mod5 = lm(gh ~ conf + yinit + hc + inv + gpop,
          data = data |> filter(period == "2000-2009"))

mod6 = lm(gh ~ conf + yinit + hc + inv + gpop,
          data = data |> filter(period == "2010-2019"))

mod7 = lm(gh ~ conf + yinit + hc + inv + gpop + period + region,
          data = data)

mod8 = lm(gh ~ conf + yinit + hc + inv + gpop + period + kkz96 +
            kgatrstr + lang, data = data)

mod21 = lm(gh ~ kkz96 + yinit + hc + inv + gpop + period, data = data)

mod22 = lm(gh ~ kkz96 + yinit + hc + inv + gpop,
           data = data |> filter(period == "1970-1979"))

mod23 = lm(gh ~ kkz96 + yinit + hc + inv + gpop,
           data = data |> filter(period == "1980-1989"))

mod24 = lm(gh ~ kkz96 + yinit + hc + inv + gpop,
           data = data |> filter(period == "1990-1999"))

mod25 = lm(gh ~ kkz96 + yinit + hc + inv + gpop,
           data = data |> filter(period == "2000-2009"))

mod26 = lm(gh ~ kkz96 + yinit + hc + inv + gpop,
           data = data |> filter(period == "2010-2019"))

mod27 = lm(gh ~ kkz96 + yinit + hc + inv + gpop + period + region,
           data = data)

mod28 = lm(gh ~ kkz96 + yinit + hc + inv + gpop + period + conf +
             kgatrstr + lang, data = data)

mod31 = lm(gh ~ kgatrstr + yinit + hc + inv + gpop + period, data = data)

mod32 = lm(gh ~ kgatrstr + yinit + hc + inv + gpop,
           data = data |> filter(period == "1970-1979"))

mod33 = lm(gh ~ kgatrstr + yinit + hc + inv + gpop,
           data = data |> filter(period == "1980-1989"))

mod34 = lm(gh ~ kgatrstr + yinit + hc + inv + gpop,
           data = data |> filter(period == "1990-1999"))

mod35 = lm(gh ~ kgatrstr + yinit + hc + inv + gpop,
           data = data |> filter(period == "2000-2009"))

mod36 = lm(gh ~ kgatrstr + yinit + hc + inv + gpop,
           data = data |> filter(period == "2010-2019"))

mod37 = lm(gh ~ kgatrstr + yinit + hc + inv + gpop + period + region,
           data = data)

mod38 = lm(gh ~ kgatrstr + yinit + hc + inv + gpop + period + kkz96 +
             conf + lang, data = data)

mod41 = lm(gh ~ lang + yinit + hc + inv + gpop + period, data = data)

mod42 = lm(gh ~ lang + yinit + hc + inv + gpop,
           data = data |> filter(period == "1970-1979"))

mod43 = lm(gh ~ lang + yinit + hc + inv + gpop,
           data = data |> filter(period == "1980-1989"))

mod44 = lm(gh ~ lang + yinit + hc + inv + gpop,
           data = data |> filter(period == "1990-1999"))

mod45 = lm(gh ~ lang + yinit + hc + inv + gpop,
           data = data |> filter(period == "2000-2009"))

mod46 = lm(gh ~ lang + yinit + hc + inv + gpop,
           data = data |> filter(period == "2010-2019"))

mod47 = lm(gh ~ lang + yinit + hc + inv + gpop + period + region,
           data = data)
