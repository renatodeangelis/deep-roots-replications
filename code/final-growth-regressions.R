...
mod1 = lm(gy ~ conf + yinit + hc + inv + gpop + period, data = data)

mod2 = lm(gy ~ conf + yinit + hc + inv + gpop,
          data = data |> filter(period == "1970-1979"))

mod3 = lm(gy ~ conf + yinit + hc + inv + gpop,
          data = data |> filter(period == "1980-1989"))

mod4 = lm(gy ~ conf + yinit + hc + inv + gpop,
          data = data |> filter(period == "1990-1999"))

mod5 = lm(gy ~ conf + yinit + hc + inv + gpop,
          data = data |> filter(period == "2000-2009"))

mod6 = lm(gy ~ conf + yinit + hc + inv + gpop,
          data = data |> filter(period == "2010-2019"))

mod7 = lm(gy ~ conf + yinit + hc + inv + gpop + period + region,
          data = data)

mod8 = lm(gy ~ conf + yinit + hc + inv + gpop + period + kkz96 +
            kgatrstr + lang, data = data)

mod21 = lm(gy ~ kkz96 + yinit + hc + pc + inv + gpop + period, data = data)

mod22 = lm(gy ~ kkz96 + yinit + hc + inv + gpop,
          data = data |> filter(period == "1970-1979"))

mod23 = lm(gy ~ kkz96 + yinit + hc + inv + gpop,
          data = data |> filter(period == "1980-1989"))

mod24 = lm(gy ~ kkz96 + yinit + hc + inv + gpop,
          data = data |> filter(period == "1990-1999"))

mod25 = lm(gy ~ kkz96 + yinit + hc + inv + gpop,
          data = data |> filter(period == "2000-2009"))

mod26 = lm(gy ~ kkz96 + yinit + hc + inv + gpop,
          data = data |> filter(period == "2010-2019"))

mod27 = lm(gy ~ kkz96 + yinit + hc + inv + gpop + period + region,
          data = data)

mod28 = lm(gy ~ kkz96 + yinit + hc + inv + gpop + period + conf +
            kgatrstr + lang, data = data)

mod31 = lm(gy ~ kgatrstr + yinit + hc + inv + gpop + period, data = data)

mod32 = lm(gy ~ kgatrstr + yinit + hc + inv + gpop,
          data = data |> filter(period == "1970-1979"))

mod33 = lm(gy ~ kgatrstr + yinit + hc + inv + gpop,
          data = data |> filter(period == "1980-1989"))

mod34 = lm(gy ~ kgatrstr + yinit + hc + inv + gpop,
          data = data |> filter(period == "1990-1999"))

mod35 = lm(gy ~ kgatrstr + yinit + hc + inv + gpop,
          data = data |> filter(period == "2000-2009"))

mod36 = lm(gy ~ kgatrstr + yinit + hc + inv + gpop,
          data = data |> filter(period == "2010-2019"))

mod37 = lm(gy ~ kgatrstr + yinit + hc + inv + gpop + period + region,
          data = data)

mod38 = lm(gy ~ kgatrstr + yinit + hc + inv + gpop + period + kkz96 +
             conf + lang, data = data)

mod41 = lm(gy ~ lang + yinit + hc + inv + gpop + period, data = data)

mod42 = lm(gy ~ lang + yinit + hc + inv + gpop,
          data = data |> filter(period == "1970-1979"))

mod43 = lm(gy ~ lang + yinit + hc + inv + gpop,
          data = data |> filter(period == "1980-1989"))

mod44 = lm(gy ~ lang + yinit + hc + inv + gpop,
          data = data |> filter(period == "1990-1999"))

mod45 = lm(gy ~ lang + yinit + hc + inv + gpop,
          data = data |> filter(period == "2000-2009"))

mod46 = lm(gy ~ lang + yinit + hc + inv + gpop,
          data = data |> filter(period == "2010-2019"))

mod47 = lm(gy ~ lang + yinit + hc + inv + gpop + period + region,
          data = data)
