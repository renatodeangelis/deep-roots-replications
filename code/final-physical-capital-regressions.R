...
mod1 = lm(gk ~ conf + yinit + hc + inv + gpop + period, data = data)

mod2 = lm(gk ~ conf + yinit + hc + inv + gpop,
          data = data |> filter(period == "1970-1979"))

mod3 = lm(gk ~ conf + yinit + hc + inv + gpop,
          data = data |> filter(period == "1980-1989"))

mod4 = lm(gk ~ conf + yinit + hc + inv + gpop,
          data = data |> filter(period == "1990-1999"))

mod5 = lm(gk ~ conf + yinit + hc + inv + gpop,
          data = data |> filter(period == "2000-2009"))

mod6 = lm(gk ~ conf + yinit + hc + inv + gpop,
          data = data |> filter(period == "2010-2019"))

mod7 = lm(gk ~ conf + yinit + hc + inv + gpop + period + region,
          data = data)

mod8 = lm(gk ~ conf + yinit + hc + inv + gpop + period + kkz96 +
            kgatrstr + lang, data = data)

mod21 = lm(gk ~ kkz96 + yinit + hc + inv + gpop + period, data = data)

mod22 = lm(gk ~ kkz96 + yinit + hc + inv + gpop,
           data = data |> filter(period == "1970-1979"))

mod23 = lm(gk ~ kkz96 + yinit + hc + inv + gpop,
           data = data |> filter(period == "1980-1989"))

mod24 = lm(gk ~ kkz96 + yinit + hc + inv + gpop,
           data = data |> filter(period == "1990-1999"))

mod25 = lm(gk ~ kkz96 + yinit + hc + inv + gpop,
           data = data |> filter(period == "2000-2009"))

mod26 = lm(gk ~ kkz96 + yinit + hc + inv + gpop,
           data = data |> filter(period == "2010-2019"))

mod27 = lm(gk ~ kkz96 + yinit + hc + inv + gpop + period + region,
           data = data)

mod28 = lm(gk ~ kkz96 + yinit + hc + inv + gpop + period + conf +
             kgatrstr + lang, data = data)

mod31 = lm(gk ~ kgatrstr + yinit + hc + inv + gpop + period, data = data)

mod32 = lm(gk ~ kgatrstr + yinit + hc + inv + gpop,
           data = data |> filter(period == "1970-1979"))

mod33 = lm(gk ~ kgatrstr + yinit + hc + inv + gpop,
           data = data |> filter(period == "1980-1989"))

mod34 = lm(gk ~ kgatrstr + yinit + hc + inv + gpop,
           data = data |> filter(period == "1990-1999"))

mod35 = lm(gk ~ kgatrstr + yinit + hc + inv + gpop,
           data = data |> filter(period == "2000-2009"))

mod36 = lm(gk ~ kgatrstr + yinit + hc + inv + gpop,
           data = data |> filter(period == "2010-2019"))

mod37 = lm(gk ~ kgatrstr + yinit + hc + inv + gpop + period + region,
           data = data)

mod38 = lm(gk ~ kgatrstr + yinit + hc + inv + gpop + period + kkz96 +
             conf + lang, data = data)

mod41 = lm(gk ~ lang + yinit + hc + inv + gpop + period, data = data)

mod42 = lm(gk ~ lang + yinit + hc + inv + gpop,
           data = data |> filter(period == "1970-1979"))

mod43 = lm(gk ~ lang + yinit + hc + inv + gpop,
           data = data |> filter(period == "1980-1989"))

mod44 = lm(gk ~ lang + yinit + hc + inv + gpop,
           data = data |> filter(period == "1990-1999"))

mod45 = lm(gk ~ lang + yinit + hc + inv + gpop,
           data = data |> filter(period == "2000-2009"))

mod46 = lm(gk ~ lang + yinit + hc + inv + gpop,
           data = data |> filter(period == "2010-2019"))

mod47 = lm(gk ~ lang + yinit + hc + inv + gpop + period + region,
           data = data)
