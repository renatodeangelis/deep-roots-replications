...
```{r}
nazi_data = read_dta("https://github.com/Jsevillamol/persistence/raw/master/datasets/5_voigthlander_and_voth_2012_data/Dataset_QJE_Replicate_with_Cities.dta")
```
